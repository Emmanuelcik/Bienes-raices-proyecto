function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive)}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}function darkMode(){const e=document.querySelector(".dark-mode"),n=window.matchMedia("(prefers-colorscheme: dark)");n.matches?document.body.classList.add("dark-modee"):document.body.classList.remove("dark-modee"),n.addEventListener("change",()=>{n.matches?document.body.classList.add("dark-modee"):document.body.classList.remove("dark-modee")}),e.addEventListener("click",()=>{document.body.classList.toggle("dark-modee")})}
